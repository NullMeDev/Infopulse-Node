...
func getDefaultFeedSources() []models.FeedSource {
	return []models.FeedSource{
		...
		{
			ID:         "github-releases",
			Name:       "GitHub New Releases",
			URL:        "https://github.com/trending.atom",
			Categories: []models.Category{models.CategoryOpenSource},
			FetchMethod: "rss",
			UpdateFreq: 240,
			Enabled:   true,
		},
		{
			...
			Categories: []models.Category{models.CategoryAITools},
			FetchMethod: "rss",
			UpdateFreq: 120,
			Enabled:   true,
		},
		...
		},
		{
			...
			Categories: []models.Category{models.CategoryCybersec},
			FetchMethod: "rss",
			UpdateFreq: 60,
			Enabled:   true,
		},
